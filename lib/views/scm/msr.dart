...
class MSRState extends State<MSR> with Validators {
  @override
  ...
  Widget _settingsView() {
    return ListView(
      children: [
        ...
        const SizedBox(height: 25),
        _buildTextField('MSR Order', Icons.person, evalName),
        ...
        const SizedBox(height: 15),
        _buildTextField('From Warehouse ID #', Icons.person_add_alt_1_sharp, evalName),
        const SizedBox(height: 15),
        _buildTextField('Centre ID #', Icons.credit_card_outlined, evalName),
        const SizedBox(height: 15),
      ...
      children: fields.map((f) {
        return Expanded(
          child: Container(
            ...
            child: _buildTextField(f[0] as String, f[1] as IconData, f[2] as String? Function(String?)),
          ),
        );
      }).toList(),
    );
