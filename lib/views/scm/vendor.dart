...
class VendorState extends State<Vendor> with Validators {
  @override
    ...
    return ListView(
      children: [
        ...
        Row(
          ...
          children: const [
            Icon(Icons.shopping_bag_rounded, color: Colors.blueAccent),
            SizedBox(width: 5),
            Text("Setup Vendor", style: cHeaderDarkText),
          ],
        ),
        const SizedBox(height: 25),
        _buildTextField('Vendor ID', Icons.person, evalName),
        ...
        const SizedBox(height: 15),
        _buildTextField('Vendor Address', Icons.person_add_alt_1_sharp, evalName),
        const SizedBox(height: 15),
